...
function Freecourseslist() {
    const filterData = list.filter((data)=>data.payed==="Free")
    // const one = list[0].id;
  return (
    <>
    <div className='max-w-screen-2x1 container mx-auto  bg-red-100 md:px-20 px-4'>
      <h1 className='dark:text-black text-2xl font-bold pt-4 md:pt-8'>Free courses</h1>
